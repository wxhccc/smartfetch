...
>(
  ...
  const coreFetchCreator =
    <RC = RequestConfig, E extends Error = Error, DataType = any>(
      fetchCore: FetchCore<DataType, RC, E>,
      useFetch = false
    ): SFetch<RC, E> =>
...
type ConfigCreator<RC = RequestConfig> = (...args: any[]) => RC
